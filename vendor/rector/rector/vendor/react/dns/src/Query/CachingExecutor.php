...
final class CachingExecutor implements ExecutorInterface
{
    ...
    public function query(Query $query)
    {
        ...
        return new Promise(function ($resolve, $reject) use($query, $id, $cache, $executor, &$pending, $that): void {
            ...
            })->then($resolve, function ($e) use($reject, &$pending): void {
                $reject($e);
                $pending = null;
            });
        }, function ($_, $reject) use(&$pending, $query): void {
