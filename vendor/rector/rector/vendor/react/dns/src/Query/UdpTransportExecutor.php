...
final class UdpTransportExecutor implements ExecutorInterface
{
    ...
    public function query(Query $query)
    {
        ...
        $loop = $this->loop;
        $deferred = new Deferred(function () use($loop, $socket, $query): void {
        ...
        $loop->addReadStream($socket, function ($socket) use($loop, $deferred, $query, $parser, $request, $max, $nameserver): void {
