...
use RectorPrefix202503\libev\EventLoop;
use RectorPrefix202503\libev\IOEvent;
use RectorPrefix202503\libev\SignalEvent;
use RectorPrefix202503\libev\TimerEvent;
...
final class ExtLibevLoop implements LoopInterface
{
    ...
    public function addReadStream($stream, $listener)
    {
        ...
        $callback = function () use($stream, $listener): void {
    ...
    public function addTimer($interval, $callback)
    {
        ...
        $callback = function () use($timer, $timers, $that): void {
    ...
    public function addPeriodicTimer($interval, $callback)
    {
        ...
        $callback = function () use($timer): void {
            \call_user_func($timer->getCallback(), $timer);
        };
    ...
    public function addSignal($signal, $listener)
    {
        ...
        if (!isset($this->signalEvents[$signal])) {
            ...
            $this->signalEvents[$signal] = new SignalEvent(function () use($signals, $signal): void {
                $signals->call($signal);
            }, $signal);
